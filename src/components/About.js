...
const About = () => {
  return (
    <div className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover">
      {/* Added pt-8 for top spacing and mb-4 for bottom margin */}
      <h1 className="text-center text-5xl md:text-4xl text-white font-medium pt-8 mb-12">
        Artista
      </h1>

      {/* Adjusted padding to pt-4 instead of py-16 to prevent overlap */}
      <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto pt-4 lg:my-0">
        ...
        <div className="w-full lg:w-3/5 rounded-lg lg:rounded-l-none lg:rounded-r-lg shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
          <div className="p-2 md:p-12 text-center lg:text-left">
            <div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-32 w-32 bg-cover bg-center">
              <img src={profilesm} alt="Profile" />
            </div>

            <h1 className="text-3xl font-bold pt-8 lg:pt-0">Shraddha Saini</h1>
